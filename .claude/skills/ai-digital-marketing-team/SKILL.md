---
name: ai-digital-marketing-team
description: AI Digital Marketing Team with 5 expert personas (Research, Content, Visual, Data, Manager) for data-driven marketing strategy using the HubSpot Loop framework. Handles brand onboarding, audience research, content strategy, visual design, performance analysis, and stakeholder reporting.
user-invocable: true
---
